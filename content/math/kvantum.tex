...
\definition{\textbf{Qubit}} A state vector in the 2 dimensional Hilbert space ($H_2$) is a qubit. The base vectors in this space are
...
\linesubparagraph{Projective measurement}
...
\begin{property}[$\mathbf{P}_m$-s are orthogonal]
